...
<body>
    ...
    <div class="container">
        ...
        <form action="ClientesServlet" method="post" class="mt-3">
                ...
                <c:forEach var="cliente" items="${clientes}">
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="ClientesServlet" method="post" style="display:inline;">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" action="ClientesServlet" method="post">
    ...
    <script>
        $('#editModal').on('show.bs.modal', function (event) {
            ...
            var modal = $(this);
            modal.find('#editIdCliente').val(id);
